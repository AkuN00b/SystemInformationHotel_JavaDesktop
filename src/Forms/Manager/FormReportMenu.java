    ...
    public FormReportMenu() {
        ...
        lihatLaporanButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    jPrint = JasperFillManager.fillReport("jasper/ReportTransaksiMenu.jasper", param, connection.conn);
                    JasperViewer viewer = new JasperViewer(jPrint, false);
                    viewer.setTitle("Laporan Transaksi Menu");
