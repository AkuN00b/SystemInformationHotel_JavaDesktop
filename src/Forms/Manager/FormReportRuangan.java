...
public class FormReportRuangan {
    ...
    public FormReportRuangan() {
        ...
        lihatLaporanButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    jPrint = JasperFillManager.fillReport("jasper/ReportTrRuangan.jasper", param, connection.conn);
                    JasperViewer viewer = new JasperViewer(jPrint, false);
                    viewer.setTitle("Laporan Transaksi Ruangan");
